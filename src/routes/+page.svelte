<script lang="ts">
	...
	if (typeof window !== 'undefined') {
		...
		if (lang && lang.startsWith('it')) {
			// Sei già sulla pagina italiana o ci resti
			if (path !== '/') {
...
<div class="funnel-sans-regular container">
	<div class="top-icons">
	...
	<div class="block-grad block">
		...
		<h2>
			Sono un laureato in Informatica, appassionato di sviluppo software e di tutto ciò che riguarda
			il mondo tech.
		</h2>
		<div class="block-links">
			<a
				href="https://www.linkedin.com/in/marianolongo"
				class="block-link"
				target="_blank"
				rel="noopener"
			>
